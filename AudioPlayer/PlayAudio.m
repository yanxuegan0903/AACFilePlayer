...
@property (nonatomic, strong) NSMutableArray *audioPacketArray;
...
- (NSMutableArray *)audioPacketArray{
    if (!_audioPacketArray) {
        _audioPacketArray = [NSMutableArray array];
    }
    return _audioPacketArray;
}
...
//self.audio=[[playAudio alloc]initWithAudio:@"/Users/xuanyuanchen/audio/daolang.mp3"];
